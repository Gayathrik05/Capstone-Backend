...
public class ProjectService {
	...
	public List<ProjectDTO> getParticular(List<Long> departmentId) {
		List<ProjectDTO> projectList = new ArrayList<>();
		for(Long i:departmentId) {
			Iterator<Project> iterator = projectRepo.findByProjectId(i).iterator();
			...
			while (iterator.hasNext()) {
				...
				projectdto.setProjectName(project.getDepartment().getRegion().getRegionName()+"-"+project.getDepartment().getDepartmentName()+"-"+project.getProjectName());
				projectdto.setStartDate(project.getStartDate());
				projectdto.setEndDate(project.getEndDate());
				projectdto.setDepartment(project.getDepartment().getDepartmentId());
				projectdto.setDepartmentName(project.getDepartment().getDepartmentName());
